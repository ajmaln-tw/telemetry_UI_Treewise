...
function SignIn(props) {
    ...
    return (
        <Grid height="100vh" container sx={{ width: 1, bgcolor: "white.main", p: { xs: 3, md: 5 } }}>
            <Paper sx={{ display: "flex", justifyContent: { xs: "center", md: "space-around" }, alignItems: "center", flexDirection: { xs: "column", md: "row" }, width: 1, height: "100%", backgroundImage: `url(${Image})`, backgroundSize: "cover", position: "relative" }} elevation={0}>
                    ...
                    <Paper item xs={12} md={5} sx={{ bgcolor: "white.main", boxShadow: 0, borderRadius: "20px", mr: { xs: "40px", lg: "95px" }, width: { xs: "100%", md: "420px", lg: "480px", xl: "560px" }, ml: 5 }} elevation={0}>
                        <Grid sx={{ display: "flex", flexDirection: "column", justifyContent: "space-evenly" }}>
                            <Box sx={{ px: { xs: 3, xl: 6 }, py: 4 }}>
                                ...
                                <Typography sx={{ fontWeight: 400, pb: { lg: 2, xl: 3 }, color: "shaded.main", fontSize: { lg: "16px", xl: "18px" } }} >{"Email"}</Typography>
                                <Box >
                                    <Form>
